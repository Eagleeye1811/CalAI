          ...
          if (!_isGenerating)
            Container(
              ...
              child: ElevatedButton.icon(
                ...
                icon: Icon(Icons.share, color: context.cardColor, size: 18),
                label: Text(
                  'Share',
                  style: TextStyle(
    ...
    return Column(
      children: [
        Container(
          ...
          child: Icon(icon, color: context.cardColor, size: 20),
        ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: 1.w),
          Text(
            'Track your nutrition with CalAI',
            style: TextStyle(
              fontSize: 12,
              color: context.textColor.withOpacity(0.6),
              fontWeight: FontWeight.w400,
  ...
  Future<void> _handleShare() async {
    ...
    try {
      ...
      try {
        ...
        String shareText = '''🍽️ Just tracked "$foodName" with CalAI! 
...
📱 Download CalAI: https://play.google.com/store/apps/details?id=com.CalAI.app

#CalAI #NutritionTracking #HealthyEating #AInutrition #FoodTracking #HealthTech''';
