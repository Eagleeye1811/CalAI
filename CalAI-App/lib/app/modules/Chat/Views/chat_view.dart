...
import 'package:calai/app/models/Agent/agent_response.dart' as AgentModel;
import 'package:calai/app/models/Auth/user.dart';
import 'package:calai/app/controllers/user_controller.dart';
import 'package:calai/app/modules/Chat/controller/chat_controller.dart';
...
class CalAIAgentView extends StatefulWidget {
  const CalAIAgentView({super.key});

  @override
  State<CalAIAgentView> createState() => _CalAIAgentViewState();
}

class _CalAIAgentViewState extends State<CalAIAgentView>
