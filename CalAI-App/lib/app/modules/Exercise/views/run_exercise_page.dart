...
class _RunExercisePageState extends State<RunExercisePage> {
  ...
  int _calculateCalories() {
    ...
    switch (_selectedIntensity) {
      case 'High':
        caloriesPerMinute = 15.0; // Sprinting
        break;
      case 'Medium':
        caloriesPerMinute = 10.0; // Jogging
        break;
      case 'Low':
        caloriesPerMinute = 4.0; // Walking
        break;
    }
        ...
        child: Column(
          ...
          children: [
            ...
            _buildIntensityOption(
              level: 'High',
              title: 'Sprinting',
              subtitle: '14 mph (4 minute miles)',
              icon: Icons.flash_on,
              color: Colors.red,
            ),
            SizedBox(height: 12),
            _buildIntensityOption(
              level: 'Medium',
              title: 'Jogging',
              subtitle: '6 mph (10 minute miles)',
            ...
            _buildIntensityOption(
              level: 'Low',
              title: 'Chill walk',
              subtitle: '3 mph (20 minute miles)',
