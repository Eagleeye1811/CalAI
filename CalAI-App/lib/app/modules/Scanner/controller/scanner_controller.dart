...
class ScannerController extends GetxController {
  ...
  RxInt consumedFiber = 0.obs;      // ADD THIS
  RxInt consumedSugar = 0.obs;      // ADD THIS
  RxInt consumedSodium = 0.obs;  
  ...
  Future<void> processNutritionQueryRequest(String userId, File image,
    ...
    try {
      ...
      int totalConsumedFiber = 0;      // ADD THIS
      int totalConsumedSugar = 0;      // ADD THIS
      int totalConsumedSodium = 0;     // ADD THIS
      ...
      for (final rec in mergedForDay) {
        ...
        if (resp?.ingredients != null) {
          for (final ing in resp!.ingredients!) {
            ...
            totalConsumedFiber += ing.fiber ?? 0;      // ADD THIS
            totalConsumedSugar += ing.sugar ?? 0;      // ADD THIS
            totalConsumedSodium += ing.sodium ?? 0;    // ADD THIS
          }
        }
      }
      ...
      final dailyNutritionRecords = DailyNutritionRecords(
        ...
        dailyConsumedFiber: totalConsumedFiber,      // ADD THIS
        dailyConsumedSugar: totalConsumedSugar,      // ADD THIS
        dailyConsumedSodium: totalConsumedSodium,    // ADD THIS
      );
      ...
      if (_dateKey(selectedDate) == key) {
        ...
        consumedFiber.value = totalConsumedFiber;        // ADD THIS
        consumedSugar.value = totalConsumedSugar;        // ADD THIS
        consumedSodium.value = totalConsumedSodium;      // ADD THIS
      }
  ...
  Future<void> getRecordByDate(String userId, DateTime selectedDate) async {
    try {
      ...
      consumedFiber.value = records.dailyConsumedFiber ?? 0;      // ADD THIS
      consumedSugar.value = records.dailyConsumedSugar ?? 0;      // ADD THIS
      consumedSodium.value = records.dailyConsumedSodium ?? 0;    // ADD THIS
    } catch (e) {
      dailyRecords.clear();
