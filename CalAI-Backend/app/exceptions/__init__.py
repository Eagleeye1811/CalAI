...
class BaseCalAIException(Exception):
    """Base exception class for all CalAI custom exceptions"""
...
class ValidationException(BaseCalAIException):
...
class ImageProcessingException(BaseCalAIException):
...
class NutritionAnalysisException(BaseCalAIException):
...
class ExternalServiceException(BaseCalAIException):
...
class ConfigurationException(BaseCalAIException):
...
class RateLimitException(BaseCalAIException):
...
class BusinessLogicException(BaseCalAIException):
