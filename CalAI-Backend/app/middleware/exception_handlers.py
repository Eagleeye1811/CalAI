...
async def CalAI_exception_handler(
    request: Request, exc: BaseCalAIException
) -> JSONResponse:
    """Handle all custom CalAI exceptions."""
    ...
    if severity in [ErrorSeverity.HIGH, ErrorSeverity.CRITICAL]:
        logfire.error("CalAI Exception", **log_data)
    elif severity == ErrorSeverity.MEDIUM:
        logfire.warn("CalAI Exception", **log_data)
    else:
        logfire.info("CalAI Exception", **log_data)
...
def setup_exception_handlers(app: FastAPI) -> FastAPI:
    ...
    app.add_exception_handler(BaseCalAIException, CalAI_exception_handler)
